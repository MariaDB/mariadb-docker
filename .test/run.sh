...
runandwait -e MYSQL_USER=bob -e MYSQL_PASSWORD=$' \' ' -e MYSQL_ROOT_PASSWORD=$'\'\\aa-\x09-zz"_%' "${image}"
mariadbclient_unix --skip-column-names -B -u root -p$'\'\\aa-\x09-zz"_%' -e 'select 1'
