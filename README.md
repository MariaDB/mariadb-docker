...
-	[![build status badge](https://img.shields.io/github/workflow/status/docker-library/mariadb/GitHub%20CI/master?label=GitHub%20CI)](https://github.com/docker-library/mariadb/actions?query=workflow%3A%22GitHub+CI%22+branch%3Amaster)
